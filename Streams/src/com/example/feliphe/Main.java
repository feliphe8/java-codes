...
//        System.out.println(concatStream.distinct().count());
        ...
        Employee irelia = new Employee("Irelia Evergreen", 23);
        Employee vayne = new Employee("Vayne Evergreen", 31);
        Employee lydia = new Employee("Lydia Evergreen", 24);

        Department hr = new Department("Human Resources");
        hr.addEmployee(feliphe);
        hr.addEmployee(irelia);
        hr.addEmployee(vayne);
        Department accounting = new Department("Accounting");
        accounting.addEmployee(lydia);
