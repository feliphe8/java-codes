...
public class Utilities {
    ...
    // Remove pairs of the same character that are next to each other , by removing on e occurence of the character.
    //"ABCDEEFE" -> "ABCDEF"
    //"ABCBDEEF" -> "ABCBDEEF" (the two B's aren't next to each other, so they aren't removed)
    public String removePairs(String source){
        // If length < 2, there wont be any pairs
